...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm text-muted-foreground outline-none transition-all duration-300 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 focus:bg-primary/5 focus:not-italic focus:text-primary',
      className,
    )}
    {...props}
  >
